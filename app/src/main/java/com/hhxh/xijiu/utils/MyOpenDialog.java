...
public class MyOpenDialog {
     ...
     * @param content
     */
    public static CustomDialog showDialog(Context context, String content) {
     ...
     */
    public static void showOneBtnListenerDialog(Context context, String title,String content,
     ...
     */
    public static void showTwoBtnListenerDialog(Context context, String content,
                                         String ok, DialogInterface.OnClickListener okListener,
     ...
     * @param cancelListener 第二个按钮监听事件
     */
    public static void showTwoBtnListenerDialog(Context context, String title, String content,
                                         String ok, DialogInterface.OnClickListener okListener,
                                         String cancel, DialogInterface.OnClickListener cancelListener) {
        try {
            if (context != null) {
    ...
    public static CustomDialog showNoBtnDialog(Context context, String title, String content) {
        CustomDialog mCustomDialog = null;
        try {
            if (context != null) {
                CustomDialog.Builder builder = new CustomDialog.Builder(context);
     ...
     */
    public static void showEditContentDialog(Context context, String title, String defualtStr, String hintStr
    ...
    public void showTwoEditDialog(Context context, boolean isSingle,String firstDefualtStr,String secondDefualtStr,
        ...
        lp.gravity = Gravity.CENTER;
        myDialog.getWindow().setBackgroundDrawable(null);
        myDialog.getWindow().setSoftInputMode(LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
        myDialog.show();
    }
